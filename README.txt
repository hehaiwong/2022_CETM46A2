...
1.	To run the R-script and R Shiny locally, firstly download 1 app.R file (core program) and 2 .csv files ,(XXX,XXXX.csv)  where are the dataset  for account and history log , from GitHub https://github.com/hehaiwong/2022_CETM46A2 .
2.	Open the R Studio.
